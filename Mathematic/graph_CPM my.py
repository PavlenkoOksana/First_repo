...
c = Canvas(root, width=1000, height=500, bg='white') # Розмір і колір полотна
c.pack()
...
tops = [
    ...
    {'x':200,'y':50,'n':'3','tmax':0,'tmin':0},
    {'x':350,'y':250,'n':'4','tmax':0,'tmin':0},
    {'x':350,'y':50,'n':'5','tmax':0,'tmin':0},
    {'x':500,'y':250,'n':'6','tmax':0,'tmin':0},
    {'x':500,'y':50,'n':'7','tmax':0,'tmin':0},
    {'x':650,'y':150,'n':'8','tmax':0,'tmin':0}
]
